...
const ProductDisplay = (props) => {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem("auth-token")) {
      fetch(
        "https://fluttering-christiana-muhammadhanzalah-eb04cdbe.koyeb.app/update-interests",
        {
          method: "POST",
          headers: {
    ...
    <div className="productdisplay">
      ...
      <div className="productdisplay-right">
        ...
        <div className="productdisplay-right-description">
          A light and soft cotton blend tee for ultimate comfort. Featuring a
          classic crew neck and short sleeves, it's perfect for everyday wear.
        </div>
