  ...
  const Add_Product = async () => {
    ...
    try {
      ...
      const uploadResponse = await fetch(
        "https://fluttering-christiana-muhammadhanzalah-eb04cdbe.koyeb.app/upload",
        {
          method: "POST",
          headers: {
      ...
      if (responseData.success) {
        ...
        const addResponse = await fetch(
          "https://fluttering-christiana-muhammadhanzalah-eb04cdbe.koyeb.app/addproduct",
          {
            method: "POST",
            headers: {
              Accept: "application/json",
      ...
      alert(
        "Could not connect to the server. Is your backend running on port 4000?"
      );
    }
  };
